...
const Channel = ({
  ...
  return (
    <div
      ...
      className="flex justify-around dark:bg-slate-800 mx-2 border-slate-800 dark:border-slate-600 rounded-xl border-[1px] min-w-[150px]  max-w-[350px] items-center p-1"
    >
      <div>
