...
const WatchHistory = () => {
  ...
  const handleWatchHistoryVideos = async () => {
    const response = await axios.get(`${process.env.BASE_URL}/api/v1/users/watch-history/${userId}`);
  ...
  const clearWatchHistory = async () => {
    const response = await axios.put(`${process.env.BASE_URL}/api/v1/videos/clear-watchhistory`);
    return response?.data;
  };
